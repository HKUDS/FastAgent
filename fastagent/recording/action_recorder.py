...
class ActionRecorder:
    ...
    This recorder captures the 'thinking' layer of agents:
    - HostAgent planning and task decomposition
    - GroundingAgent tool selection reasoning
    - EvalAgent evaluation decisions
    """
    ...
    async def record_action(
        ...
        # Add related kanban events for correlation
        if related_kanban_events:
            action_info["related_kanban_events"] = related_kanban_events
