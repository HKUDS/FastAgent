...
from fastagent.config.constants import PROJECT_ROOT

if TYPE_CHECKING:
    from fastagent.grounding.core.tool import BaseTool
    from fastagent.grounding.core.types import ToolResult
...
class ToolQualityManager:
    ...
    def __init__(
        ...
        *,
        ...
        self._cache_dir = cache_dir or PROJECT_ROOT / ".fastagent" / "tool_quality"
